    ...
    var mobileNav = function () {
        ...
        function responsivemenu(mobile) {
            if (mobile.matches) {
                ...
                $(".manekin").removeClass("active");

                $(".mobile-button-style2").removeClass("active");
                $(".sub-menu").css({ display: "block" });
            }
        }
        $(document).on("click", ".mobile-button, .manekin, .mobile-button-style2", function () {
        ...
        $('body').on("click", function (event) {
            if (!$(event.target).closest("#main-nav-mobi").length &&
                !$(event.target).closest(".mobile-button, .manekin").length) {
                $("#main-nav-mobi").slideUp();
                $(".mobile-button, .manekin").removeClass("active");
                console.log("Menu closed"); // Debug message
            }
        });

        // Prevent closing when clicking inside the menu
        $(document).on("click", "#main-nav-mobi", function (event) {
